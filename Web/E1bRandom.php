...
//Joe Ahlbrandt
//Exam PART B 
//1b (create a random problem)

//if you want to see the output of this use the E1bOutput.php 
//or uncomment print_r($os); at the bottom of the page to see the output
...
for ($x=0; $x<$numSuppliers;$x++){
	for ($i=0; $i<$numDepartments;$i++){
		$cs=$suppliers[$x]; //cs = current supplier
		$cd=$departments[$i]; //cd = current department
		$distanceMatrix["$suppliers[$x]-$departments[$i]"]=new Distance(rand(1,50));
	}
}
...
//if you want to see this work please uncomment print_r($os); below
